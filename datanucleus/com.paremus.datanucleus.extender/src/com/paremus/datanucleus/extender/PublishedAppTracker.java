...
public class PublishedAppTracker extends ServiceTracker {

	private DatabaseConnectionConfigurer configurer;

	public PublishedAppTracker(BundleContext context, DatabaseConnectionConfigurer configurer, String uriMatch) {
